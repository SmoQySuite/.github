...
implementing various numerical methods based on many-body techniques to support research efforts studying
...
- [SmoQyElPhQMC.jl](https://github.com/SmoQySuite/SmoQyElPhQMC.jl.git): Perform quantum Monte Carlo (DQMC) simulations of electron-phonon models with a computational cost that scales near linearly with the system size and inverse temperature. This package extends the functionality of the [SmoQyDQMC.jl](https://github.com/SmoQySuite/SmoQyDQMC.jl.git) package.
...
- [SmoQyKPMCore.jl](https://github.com/SmoQySuite/SmoQyKPMCore.jl.git): A lightweight and flexible implementation of the Kernel Polynomial Method (KPM) for approximating function of Hermitian matrices.
